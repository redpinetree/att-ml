...
SRC_CMD = ./cpp_cmd/cmd_approx.cpp ./cpp_cmd/observables.cpp ./cpp_cmd/algorithm.cpp ./cpp_cmd/cmd/optimize.cpp ./cpp_cmd/graph_utils.cpp ./cpp_cmd/site.cpp ./cpp_cmd/bond.cpp ./cpp_cmd/mpi_utils.cpp
...
%.o: %.cpp
	$(MPICXX) -I ./cpp_cmd/cmd -c $< -o $@ $(CXXFLAGS)
