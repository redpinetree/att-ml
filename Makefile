...
# SRC = ./cpp/bond_utils.cpp ./cpp/site.cpp ./cpp/bond.cpp ./cpp/graph_utils.cpp ./cpp/graph.cpp ./cpp/algorithm.cpp ./cpp/tree_approx_potts.cpp 
SRC = ./cpp/tree_approx_potts.cpp ./cpp/algorithm.cpp ./cpp/graph.cpp ./cpp/graph_utils.cpp ./cpp/site.cpp ./cpp/bond.cpp ./cpp/bond_utils.cpp
