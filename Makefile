...
# all: $(TARGET_CMD) $(TARGET_RENYI) $(TARGET_CPD) $(TARGET_TREE_ML_SPIN) $(TARGET_TREE_ML) $(TARGET_TREE_ML_BORN)
all: $(TARGET_TREE_ML_SPIN) $(TARGET_TREE_ML) $(TARGET_TREE_ML_BORN)
cmd: $(TARGET_CMD)
renyi: $(TARGET_RENYI)
cpd: $(TARGET_CPD)
