...
namespace observables{
    ...
    extern std::map<std::tuple<size_t,size_t,size_t,size_t,std::vector<size_t>,std::vector<double> >,std::complex<double> > known_factors_complex;
    ...
    template<typename cmp>
    std::complex<double> m(graph<cmp>&,size_t,size_t,size_t,size_t,size_t,std::vector<double>);
    template<typename cmp>
    std::complex<double> m(graph<cmp>&,size_t,size_t,size_t,size_t,std::vector<size_t>,std::vector<double>,size_t); //top-down
    template<typename cmp>
    std::complex<double> m(graph<cmp>&,size_t,size_t,size_t,std::vector<double>);
    template<typename cmp>
    std::complex<double> m(graph<cmp>&,size_t,size_t,size_t,std::vector<size_t>,std::vector<double>); //bottom-up
