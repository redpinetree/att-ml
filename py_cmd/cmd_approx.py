...
while beta<=args.max_beta:
	...
	if args.sort_by_j:
		bonds.sort(key=lambda b: (b.up is None,np.abs(0.5*np.log(b.w[0,0]/b.w[0,1])),2-(sites[b.v1].virtual_flag+sites[b.v2].virtual_flag),b.orig_v1,b.orig_v2))
	else:
		bonds.sort(key=lambda b: (b.up is None,np.round(b.bmi,14),2-(sites[b.v1].virtual_flag+sites[b.v2].virtual_flag),b.orig_v1,b.orig_v2))
	# print(bonds)
