...
double optimize::kl_div(double z,std::vector<site> sites,bond old_current,std::vector<bond> old_cluster,bond current,std::vector<bond> cluster){
    ...
    // }
    // std::cout<<((a/z)+(b/z)-log(z))<<" "<<((a_prime/z)+(b_prime/z)-log(z_prime))<<"\n";
