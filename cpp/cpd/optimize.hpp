...
namespace optimize{
    ...
    array3d<double> mu_renyi(bond&,std::vector<bond>&,bond,std::vector<bond>,size_t,array3d<double>&,std::vector<double>&,double);
    ...
    double calc_cmd(size_t,size_t,std::vector<site>&,bond&,std::vector<bond>&,bond&,std::vector<bond>&);
