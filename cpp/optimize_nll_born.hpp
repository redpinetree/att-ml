...
namespace optimize{
    ...
    template<typename cmp>
    array4d<double> fused_update_born(graph<cmp>&,bond&,bond&,double,std::vector<double>&,std::vector<array2d<double> >&,std::vector<array2d<double> >&,std::vector<array2d<double> >&,std::map<std::pair<int,int>,array4d<double> >&,std::map<std::pair<int,int>,array4d<double> >&,int,double,double,double,double);
    template<typename cmp>
    double calc_bmi_born(graph<cmp>&,bond&,std::vector<double>&,std::vector<array2d<double> >&,std::vector<array2d<double> >&,std::vector<array2d<double> >&);
